import{_ as t,r as l,o,c as a,a as e,b as s,e as i,d as u}from"./app.150355ce.js";const d={},r=e("h1",{id:"client-groups",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#client-groups","aria-hidden":"true"},"#"),i(" Client Groups")],-1),c=e("p",null,"Rport client group can be created by:",-1),v=e("ol",null,[e("li",null,"adding single clients to it;"),e("li",null,"dynamic criteria using wildcards.")],-1),m=i("Managing client groups is done via the "),p={href:"https://apidoc.rport.io/master/#tag/Client-Groups",target:"_blank",rel:"noopener noreferrer"},q=i("API"),b=i(". The "),g=e("code",null,"/client-groups",-1),h=i(" endpoints allow you to create, update, delete and list them."),x=u(`<p>As listed in the API docs Client Group is defined by:</p><ul><li><p><code>id</code> - unique group identifier</p></li><li><p><code>description</code> - group description</p></li><li><p><code>params</code> - parameters that define what clients belong to a current group. Each parameter can be specified by:</p><ul><li>exact match of the property <strong>(ignoring case)</strong>. For example,<div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>params: {
